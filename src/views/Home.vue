        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad aborda el uso de la analítica avanzada para optimizar la toma de decisiones en empresas, destacando herramientas como algoritmos de optimización, análisis de datos en tiempo real y machine learning. Se exploran aplicaciones prácticas en la gestión de la cadena de suministro, segmentación de clientes, formulación de estrategias empresariales e indicadores clave de desempeño. A través de casos reales y tendencias actuales, se evidencian los beneficios de estas tecnologías en eficiencia, rentabilidad y competitividad. También se analizan fracasos para identificar lecciones valiosas en su implementación.
